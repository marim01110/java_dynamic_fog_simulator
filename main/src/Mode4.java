  ...
  static void main(){
    ...
    while(time_count < App.TIME){
      ...
      for(int i = 0; i < node_list.size(); i++){
        ...
        Data_mng.update_delete_order(stored_contents_list, last_used, need_data_num);
        ...
        Data_mng.search(dynamic_fog_list, stored_contents_list, last_used, nearest_dynamic_fog, need_data_num);
      }
    }
